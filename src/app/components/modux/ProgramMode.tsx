        ...
        <div className="max-w-5xl mx-auto space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 animate-in fade-in slide-in-from-bottom-4 duration-500" style={{ animationDelay: '200ms' }}>
            <button
              ...
              className="flex items-center justify-center gap-2 py-4 bg-purple-600 text-white rounded-xl font-semibold hover:bg-purple-700 hover:shadow-lg hover:scale-105 transition-all duration-300"
            >
              <Play className="w-5 h-5" />
              Analisar código
            </button>
            <button className="py-4 bg-white text-gray-700 border-2 border-purple-500 rounded-xl font-semibold hover:bg-purple-50 hover:scale-105 transition-all duration-300">
              Sugerir correção
            </button>
            <button className="py-4 bg-white text-gray-700 border-2 border-gray-300 rounded-xl font-semibold hover:bg-gray-50 hover:scale-105 transition-all duration-300">
              Explicar conceito
            </button>
          </div>
